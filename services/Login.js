...
Login.prototype.validateToken = function (userToken, adminToken) {
    return new Promise(function (fulfill, reject) {
        ...
        request.post("http://openam-psl.atosresearch.eu:8080/openam/json/policies?_action=evaluate", argsAuthenticate, function (data, response) {
            var hasAccess = false;
...
Login.prototype.requestAdminToken = function () {
   ...
   return new Promise(function (fulfill, reject) {
        request.post("http://openam-psl.atosresearch.eu:8080/openam/json/authenticate", args, function (data, response) {
